...
BEGIN
  ...
  SELECT CAST(GETDATE() AS date), CAST(GETDATE() AS time), 'MGL20052', 'Agregar', 'Paciente', 'Se agrego el paciente con ID: ' + CONVERT(VARCHAR(10), ID_Paciente)
  FROM INSERTED 
END;
...
BEGIN
  ...
  INSERT INTO Bitacora (Fecha, Hora, ID_Usuario, Accion, TablaAfectada, Descripcion)
  SELECT CAST(GETDATE() AS date), CAST(GETDATE() AS time), 'MGL20052', 'Borrar', 'Paciente', 'Se borro el paciente con ID: ' + CONVERT(VARCHAR(10), ID_Paciente)
  FROM INSERTED 
END;
...
BEGIN
  ...
  INSERT INTO Bitacora (Fecha, Hora, ID_Usuario, Accion, TablaAfectada, Descripcion)
  SELECT CAST(GETDATE() AS date), CAST(GETDATE() AS time), 'MGL20052', 'Agregar', 'Doctor', 'Se agrego el Doctor con ID: ' + CONVERT(VARCHAR(10), ID_Doctor)
  FROM INSERTED 
END;
...
BEGIN
  ...
  INSERT INTO Bitacora (Fecha, Hora, ID_Usuario, Accion, TablaAfectada, Descripcion)
  SELECT CAST(GETDATE() AS date), CAST(GETDATE() AS time), 'MGL20052', 'Borrar', 'Doctor', 'Se borro el Doctor con ID: ' + CONVERT(VARCHAR(10), ID_Doctor)
  FROM INSERTED 
END;
...
BEGIN
  ...
  INSERT INTO Bitacora (Fecha, Hora, ID_Usuario, Accion, TablaAfectada)
  SELECT CAST(GETDATE() AS date), CAST(GETDATE() AS time), 'MGL20052', 'Agregar', 'Recepcion', 'Se agrego el Recepcionista con ID: ' + CONVERT(VARCHAR(10), ID_Recepcion)
  FROM INSERTED 
END;
...
BEGIN
  ...
  INSERT INTO Bitacora (Fecha, Hora, ID_Usuario, Accion, TablaAfectada, Descripcion)
  SELECT CAST(GETDATE() AS date), CAST(GETDATE() AS time), 'MGL20052', 'Borrar', 'Recepcion', 'Se borro el Recepcionista con ID: ' + CONVERT(VARCHAR(10), ID_Recepcion)
  FROM INSERTED 
END;
